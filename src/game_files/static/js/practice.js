...
function create_practice_scene() {
    ...
    enemies_left = this.create_enemies("LEFT",6, 30, 50, "a", 5, 10, "enemylaser", min_x = 0, max_x = 350); 
    enemies_right = this.create_enemies("RIGHT",6, 450, 50, "b", 5, 10, "enemylaser", min_x = 420, max_x = 600);
