...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        ...
        handlers = [
            ...
            (r"/robot_sleep_ns",RobotSleepNSHandler),
            (r"/shutter_wake", ShutterWakeHandler),
            (r"/shutter_ingame", ShutterIngameHandler),
            (r"/shutter_sleep", ShutterSleepHandler)
            ]
...
class RobotSleepNSHandler(tornado.websocket.WebSocketHandler):
    # put in __init__
    def __init__(
        self,
        application: tornado.web.Application,
    ...
    def get(self):
        self.robot_action_pub.publish("sleep_no_speech")

class ShutterWakeHandler(tornado.websocket.WebSocketHandler):
    # put in __init__
    def __init__(
        self,
        application: tornado.web.Application,
        ...
        **kwargs: Any
        ...
        # Publisher
        self.robot_action_pub = rospy.Publisher('shutter_si/game_state',String,queue_size=5)
    
    def get(self):
        self.robot_action_pub.publish("start_game")

class ShutterIngameHandler(tornado.websocket.WebSocketHandler):
    # put in __init__
    def __init__(
        self,
        application: tornado.web.Application,
    ...
    def get(self):
        self.robot_action_pub.publish("in_game")

class ShutterSleepHandler(tornado.websocket.WebSocketHandler):
    # put in __init__
    def __init__(
        self,
        application: tornado.web.Application,
    ...
    def get(self):
        self.robot_action_pub.publish("outside_game")
